...
<Steps>
  ...
  <Step title="Configure Notifications" stepNumber={7}>
    Set up email notifications for incident alerts (Sentinel module only).
...
<CardGroup cols={2}>
  <Card title="XDR Deployment Guide" icon="shield" href="/guides/onboarding/defender-xdr-module-deployment">
    Complete step-by-step guide for Defender XDR module deployment
  </Card>
  <Card title="Defender XDR Enterprise Application" icon="key" href="/guides/onboarding/workspace-onboarding">
...
<CardGroup cols={2}>
  <Card title="Sentinel Deployment Guide" icon="database" href="/guides/onboarding/microsoft-sentinel-module">
    Complete step-by-step guide for Sentinel module deployment
  </Card>
  <Card title="Azure Resources Reference" icon="cloud" href="/guides/technical/azure-resources-deployed">
...
<CardGroup cols={2}>
  <Card title="CMS Onboarding" icon="file-code" href="/guides/onboarding/cms-module">
    Deploy detection rules after Sentinel onboarding is complete
  </Card>
  <Card title="Notifications Setup" icon="bell" href="/guides/onboarding/notifications-module">
...
<Card title="User & Group Management Guide" icon="users" href="/guides/onboarding/user-group-management-for-providers">
...
| ------------- | ------------------------------------------- |
| Denfender XDR | 5-15 minutes (depends on Defender activity) |
...
2. **Review Azure deployment logs** (Sentinel module) in the Azure Portal
...
<Note>
  Questions about onboarding? Contact us at [support@contraforce.com](mailto:support@contraforce.com) or request hands-on support for your first deployments.De
</Note>
...
Left-click an entity icon in the Entity Context Graph. The **Incident Response Carousel** appears with available actions for that entity type.
...
<Frame>
  ![Gamebook with actions added](/images/gamebook-actions-added.png)
</Frame>

...
<Steps>
  <Step title="Locate the Icon">
    Find the **Workspaces icon** (three dots) in the left navigation bar
  </Step>
...
<Card title="Learn More" icon="arrow-up-right-from-square" href="/guides/onboarding/platform-onboarding">

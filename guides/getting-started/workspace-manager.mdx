...
<Frame>
  ![Module configuration options](/images/workspace-module-config.png)
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="QRadar Settings">
...
<Note>
  Questions about the Workspaces Page? Contact us at [support@contraforce.com](mailto:support@contraforce.com).aa
</Note>
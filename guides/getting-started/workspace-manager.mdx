...
<Tabs>
  ...
  <Tab title="Modules">
    **Enable/disable ContraForce modules:**
    ...
    <Tip>
      You can access the Content Management System for Microsoft Sentinel by clickig the icon in MIcrosoft Sentinel module.
    </Tip>
    - Microsoft O365 Module (Response for emails)
    - Microsoft Entra ID Module (Response for users)
    - Microsoft Azure Module (Response for Azure NSG)
  </Tab>
  <Tab title="IAM">
    **Manage consent and access:**

    Enterprise application consents

    API permissions

    Response action authorizations
  </Tab>

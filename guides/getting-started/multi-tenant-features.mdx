...
<CardGroup cols={3}>
  ...
  <Card title="Consistent Workflows" icon="arrows-rotate">
    Same response process across every tenant
  </Card>
...
| Card                         | Multi-Tenant Capability                               |
| ---------------------------- | ----------------------------------------------------- |
| **Incident Tracker**         | High severity and total incident counts per workspace |
| **Latest Gamebook Activity** | Recent response actions across all tenants            |
| **Data Connector Anomalies** | Connector health issues by workspace                  |
| **Incidents Table**          | All incidents from all tenants in one view            |

### Default Behavior

By default, the Command Page displays data for all onboarded tenants. This gives you immediate visibility into your entire customer base without any configuration.

<Tip>
  Start your day on the Command Page to quickly identify which customers need attention. High severity incidents are surfaced automatically.
</Tip>
...
<Frame>
  ![Workspace filter selection](/images/workspace-filter-selection.png)
</Frame>
...
<Card title="Learn More" icon="folder-tree" href="/guides/getting-started/contraforce-workspaces-page">
  Complete guide to the Workspaces Page
</Card>

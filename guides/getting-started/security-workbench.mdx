---
title: "Security Workbench Overview"
...
<Frame>
  <img src="/images/security-workbench-overview.png" alt="ContraForce Security Workbench" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="AI-Mapped Playbooks" icon="brain">
    Automatically recommended response actions based on affected entity types
  </Card>
  <Card title="Entity Visualization" icon="diagram-project">
...
<Frame>
  <img src="/images/entity-action-carousel.png" alt="Entity action carousel" />
</Frame>
...
<Frame>
  <img src="/images/gamebook-actions-added.png" alt="Gamebook with actions added" />
</Frame>
...
<Frame>
  <img src="/images/gamebook-execution-complete.png" alt="Gamebook execution complete" />
</Frame>
...
<Frame>
  <img src="/images/gamebook-history-tab.png" alt="Gamebook History tab" />
</Frame>
...
<Frame>
  <img src="/images/gamebook-activity-page.png" alt="Gamebook Activity page" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Entity Insights" icon="lightbulb" href="/guides/technical/entity-insights-available-in-contraforce">

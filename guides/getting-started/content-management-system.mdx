...
<Info>
  CMS is available for workspaces with the **Microsoft Sentinel module** deployed. Detection rules are continuously updated by ContraForce's security engineering team.
</Info>
...
<CardGroup cols={2}>
  <Card title="Expert-Authored Rules" icon="shield-check">
    Detection content written by security engineers, continuously updated
  </Card>
...
CMS provides detection rules for threats across your Microsoft Sentinel data sources:
...
<CardGroup cols={3}>
  ...
  <Card title="And More" icon="plus">
    The library continuously expands within the Content Management System module with  new detections
  </Card>
</CardGroup>

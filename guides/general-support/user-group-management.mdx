...
<Frame>
  ![User management in onboarding wizard](/images/user-management-onboarding-wizard.png)
</Frame>
...
<Frame>
  ![User Management service principal consent](/images/user-management-consent.png)
</Frame>
...
<Frame>
  ![User Management settings page](/images/user-management-settings-page.png)
</Frame>
...
<Frame>
  ![Add user dialog](/images/user-management-add-user.png)
</Frame>
...
<Tabs>
  <Tab title="Admin">
    **Full access to all workspace features**
    ...
    _Best for: Team leads, senior analysts, workspace owners_
  </Tab>
  <Tab title="Incident Responder">
    **Operational access for active response**
    ...
    _Best for: SOC analysts who need to take action_
  </Tab>
  <Tab title="Incident Analyst">
    **Read-only access for investigation**
    ...
    _Best for: Junior analysts, read-only stakeholders_
  </Tab>
  <Tab title="Data Source Admin">
    **Integration management focus**
    ...
    _Best for: Integration specialists, IT administrators_
  </Tab>
</Tabs>

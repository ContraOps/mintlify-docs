...
<Info>
  Agent Center leverages Azure AI Foundry to provision the AI infrastructure required for automated security operations. Once deployed, you can configure Security Delivery Agents to handle incidents automatically.
</Info>
...
| Tool                 | Purpose                                                      |
| -------------------- | ------------------------------------------------------------ |
| **Azure AI Foundry** | Azuer AI Foundry platform for AI infrastructure provisioning |

...
The AI Agent Center enables you to deploy Azure AI Foundry infrastructure directly through ContraForce, powering automated incident investigation and response capabilities with Security Delivery Agents (SDAs).
...
| Tool                  | Purpose                                                      |
| --------------------- | ------------------------------------------------------------ |
| **Microsoft Foundry** | Azure AI Foundry platform for AI infrastructure provisioning |
...
<Steps>
  ...
  <Step title="Navigate to AI Agent Center">
    From the main dashboard, locate and select the **AI Agent Center** option
  </Step>
  <Step title="Deploy Azure AI Foundry Infrastructure">
    Follow the on-screen prompts to configure and provision the Azure AI Foundry infrastructure in your environment
  </Step>
...
<Tip>
  The deployment process handles all Azure resource provisioning automatically. You don't need to manually configure Azure AI Foundry resources.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Understanding Gamebooks" icon="book" href="/guides/response/gamebooks-overview">
    Learn about automated response playbooks
  </Card>
  <Card title="Incident Management" icon="triangle-exclamation" href="/guides/incidents/incident-management-overview">
    Overview of incident handling in ContraForce
  </Card>
  <Card title="User Roles and Permissions" icon="users" href="/guides/onboarding/platform-onboarding">

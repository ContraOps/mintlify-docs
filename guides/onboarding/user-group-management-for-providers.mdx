...
**Path:** Workspaces → [Select Customer] → IAM (Equalizer Icon) → Users & Groups
...
<CardGroup cols={2}>
  <Card title="Roles & Permissions" icon="user-shield" href="/guides/technical/contraforce-user-roles">

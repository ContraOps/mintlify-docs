---
title: "Onboarding Customer Workspaces"
description: "Complete guide to onboarding customers to ContraForce. Understand prerequisites, module options, deployment steps, and timeline expectations."
---
...
| Global Admin credentials    | Consent flow        | [admin@acmecorp.com](mailto:admin@acmecorp.com)                 |
...
| Notification email          | All deployments     | [soc-alerts@yourcompany.com](mailto:soc-alerts@yourcompany.com) |
...
<Card title="Module Selection Guide" icon="compass" href="/guides/getting-started/module-overview">
...
<Steps>
  ...
  <Step title="Consent Core Enterprise Applications">
  ...
  <Step title="Consent Module Applications">
  ...
  <Step title="Configure Azure Resources (SIEM Only)">
    For XDR + SIEM module, deploy Azure resources including Lighthouse delegation and Apollo infrastructure.
